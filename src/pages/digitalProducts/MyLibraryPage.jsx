      ...
      <div className="max-w-3xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="bg-white/[0.03] border border-white/8 rounded-3xl p-10 text-center">
            ...
            <button onClick={() => navigate("/marketplace")} className="px-5 py-3 rounded-2xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-sm transition">
              ...
              <div key={product._id} className="bg-white/[0.03] border border-white/8 rounded-3xl p-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <h3 onClick={() => navigate(`/marketplace/${product._id}`)} className="font-bold text-sm truncate cursor-pointer hover:text-purple-400 transition">
                      {product.title}
                    </h3>
                ...
                {product.canDownload && (
                  <div className="mt-4 space-y-2">
                    <button
                      ...
                      className="w-full py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 disabled:opacity-50 text-white text-xs font-bold transition flex items-center justify-center gap-1.5"
                    >
